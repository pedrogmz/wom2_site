<?PHP
	...
	foreach ($bannav as $banni){ 
		...
		if($comparaison!==false){
			echo '<html><head><title>Error (2) </title></head><body><style>.genericError{border: 1px dashed #CC0000;font-family: Tahoma;background-color: #FBEEEB;padding: 10px;color: #CC0000;}</style><div class="genericError"><strong>Error R1z <3 (2)</strong><br/> Lo sentimos <br><br>Este sitio no puede ser copiado, con este programa.</div></body></html>';
			exit;
		}
	}
